...
import { simulateNFA } from './nfaEngine';
import { nfaPresets } from './nfaPresets';
import { nfaTheory } from './nfaTheory';
...
function NFAView() {
  ...
  function handleLoadExample() {
    const currentIdx = machine
      ? nfaPresets.findIndex((p) => p.id === machine.id)
      : -1;
    const nextIdx = (currentIdx + 1) % nfaPresets.length;
    loadPreset(nfaPresets[nextIdx]);
  }
  ...
  return (
    <>
      ...
      <div className="left-panel">
        <TheoryPanel theory={nfaTheory} preset={currentPreset} />
        <PresetSelector
          presets={nfaPresets}
